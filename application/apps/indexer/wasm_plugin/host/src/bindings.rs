...
pub mod host {
    ...
    pub mod parse {
        ...
        pub mod parsing {
            ...
            unsafe impl _rt::WasmResource for Results {
                #[inline]
                unsafe fn drop(_handle: u32) {
                    ...
                    #[cfg(target_arch = "wasm32")]
                    {
                        #[link(wasm_import_module = "host:parse/parsing")]
                        extern "C" {
                            #[link_name = "[resource-drop]results"]
                            fn drop(_: u32);
                        }
            ...
            impl Results {
                ...
                pub fn add(&self, item: Result<&ParseReturn, &Error>) {
                    unsafe {
                        #[repr(align(8))]
                        ...
                        *ptr0.add(0).cast::<i32>() = (self).handle() as i32;
                        match item {
                            Ok(e) => {
                                        ...
                                        match e {
                                            ParseYield::Message(e) => {
                                                *ptr0.add(24).cast::<u8>() = (0i32) as u8;
                                                ...
                                                let len2 = vec2.len();
                                                *ptr0.add(36).cast::<usize>() = len2;
                                                *ptr0.add(32).cast::<*mut u8>() = ptr2.cast_mut();
                                            }
                                            ParseYield::Attachment(e) => {
                                                ...
                                                *ptr0.add(40).cast::<i64>() = _rt::as_i64(size3);
                                                match created_date3 {
                                                    Some(e) => {
                                                ...
                                                match modified_date3 {
                                                    Some(e) => {
                                                        *ptr0.add(60).cast::<u8>() = (1i32) as u8;
                                                        let vec6 = e;
                                                        let ptr6 = vec6.as_ptr().cast::<u8>();
                                                        let len6 = vec6.len();
                                                        *ptr0.add(68).cast::<usize>() = len6;
                                                        *ptr0.add(64).cast::<*mut u8>() =
                                                            ptr6.cast_mut();
                                                    }
                                                    None => {
                                                ...
                                                let len7 = vec7.len();
                                                *ptr0.add(76).cast::<usize>() = len7;
                                                *ptr0.add(72).cast::<*mut u8>() = ptr7.cast_mut();
                                                let vec8 = data3;
                                                let ptr8 = vec8.as_ptr().cast::<u8>();
                                                let len8 = vec8.len();
                                                *ptr0.add(84).cast::<usize>() = len8;
                                                *ptr0.add(80).cast::<*mut u8>() = ptr8.cast_mut();
                                            }
                                            ParseYield::MessageAndAttachment(e) => {
                                                *ptr0.add(24).cast::<u8>() = (2i32) as u8;
                                                ...
                                                let len10 = vec10.len();
                                                *ptr0.add(36).cast::<usize>() = len10;
                                                *ptr0.add(32).cast::<*mut u8>() = ptr10.cast_mut();
                                                let Attachment {
                                                    name: name11,
                                                    size: size11,
                                                    created_date: created_date11,
                                                    modified_date: modified_date11,
                                                    messages: messages11,
                                                    data: data11,
                                                } = t9_1;
                                                let vec12 = name11;
                                                ...
                                                let len12 = vec12.len();
                                                *ptr0.add(44).cast::<usize>() = len12;
                                                *ptr0.add(40).cast::<*mut u8>() = ptr12.cast_mut();
                                                *ptr0.add(48).cast::<i64>() = _rt::as_i64(size11);
                                                match created_date11 {
                                                    Some(e) => {
                                ...
                                *ptr0.add(96).cast::<i64>() = _rt::as_i64(cursor1);
                            }
                            Err(e) => {
                                ...
                                match e {
                                    Error::Parse(e) => {
                                        *ptr0.add(16).cast::<u8>() = (0i32) as u8;
                                        ...
                                        let len17 = vec17.len();
                                        *ptr0.add(24).cast::<usize>() = len17;
                                        *ptr0.add(20).cast::<*mut u8>() = ptr17.cast_mut();
                                    }
                                    Error::Incomplete => {
                                        *ptr0.add(16).cast::<u8>() = (1i32) as u8;
                                    }
            ...
            impl Results {
                #[allow(unused_unsafe, clippy::all)]
                pub fn add_range(&self, items: &[Result<ParseReturn, Error>]) {
                    unsafe {
                        let vec17 = items;
                        let len17 = vec17.len();
                        let layout17 =
                            _rt::alloc::Layout::from_size_align_unchecked(vec17.len() * 96, 8);
                            ...
                            let base = result17.add(i * 96);
                            {
                                match e {
                                    Ok(e) => {
                                                ...
                                                match e {
                                                    ...
                                                    ParseYield::Attachment(e) => {
                                                        ...
                                                        *base.add(32).cast::<i64>() =
                                                        ...
                                                        let ptr6 = vec6.as_ptr().cast::<u8>();
                                                        let len6 = vec6.len();
                                                        *base.add(68).cast::<usize>() = len6;
                                                        *base.add(64).cast::<*mut u8>() =
                                                            ptr6.cast_mut();
                                                        let vec7 = data2;
                                                        let ptr7 = vec7.as_ptr().cast::<u8>();
                                                        let len7 = vec7.len();
                                                        *base.add(76).cast::<usize>() = len7;
                                                    ...
                                                    ParseYield::MessageAndAttachment(e) => {
                                                        ...
                                                        *base.add(24).cast::<*mut u8>() =
                                                        ...
                                                        let Attachment {
                                                            name: name10,
                                                            size: size10,
                                                            created_date: created_date10,
                                                            modified_date: modified_date10,
                                                            messages: messages10,
                                                            data: data10,
                                                        } = t8_1;
                                                        let vec11 = name10;
                                                        ...
                                                        *base.add(40).cast::<i64>() =
                                                            _rt::as_i64(size10);
                                                        match created_date10 {
                                                            Some(e) => {
                                                                *base.add(48).cast::<u8>() =
                                                                    (1i32) as u8;
                                                                let vec12 = e;
                                                                let ptr12 =
                                                                    vec12.as_ptr().cast::<u8>();
                                                                let len12 = vec12.len();
                                                                *base.add(56).cast::<usize>() =
                                                                    len12;
                                                        ...
                                                        match modified_date10 {
                                                            Some(e) => {
                                                                *base.add(60).cast::<u8>() =
                                                                    (1i32) as u8;
                                                                let vec13 = e;
                                                                let ptr13 =
                                                                    vec13.as_ptr().cast::<u8>();
                                                                let len13 = vec13.len();
                                                                *base.add(68).cast::<usize>() =
                                                                    len13;
                                                                *base.add(64).cast::<*mut u8>() =
                                                                    ptr13.cast_mut();
                                                            }
                                                        ...
                                                        let vec14 = messages10;
                                                        let ptr14 = vec14.as_ptr().cast::<u8>();
                                                        let len14 = vec14.len();
                                                        *base.add(76).cast::<usize>() = len14;
                                                        *base.add(72).cast::<*mut u8>() =
                                                            ptr14.cast_mut();
                                                        let vec15 = data10;
                                                        let ptr15 = vec15.as_ptr().cast::<u8>();
                                                        let len15 = vec15.len();
                                                        *base.add(84).cast::<usize>() = len15;
                                        ...
                                        *base.add(88).cast::<i64>() = _rt::as_i64(cursor0);
                                    }
                                    Err(e) => {
                        ...
                        #[link(wasm_import_module = "host:parse/parsing")]
                        extern "C" {
                            #[link_name = "[method]results.add-range"]
                        ...
                        wit_import((self).handle() as i32, result17, len17);
                        if layout17.size() != 0 {
    ...
    pub mod host {
        ...
        pub mod parse {
            ...
            pub mod client {
                ...
                pub type Error = super::super::super::super::host::parse::parsing::Error;
                pub type ParseReturn =
                    super::super::super::super::host::parse::parsing::ParseReturn;
                pub type Results = super::super::super::super::host::parse::parsing::Results;
                ...
                unsafe impl _rt::WasmResource for Parser {
                    ...
                    unsafe fn drop(_handle: u32) {
                        ...
                        #[cfg(target_arch = "wasm32")]
                        {
                            #[link(wasm_import_module = "[export]host:parse/client")]
                            extern "C" {
                ...
                pub unsafe fn _export_method_parser_parse_cabi<T: GuestParser>(
                    ...
                    let len22 = vec22.len();
                    let layout22 =
                        _rt::alloc::Layout::from_size_align_unchecked(vec22.len() * 96, 8);
                    ...
                    for (i, e) in vec22.into_iter().enumerate() {
                        let base = result22.add(i * 96);
                        {
                            match e {
                                Ok(e) => {
                                    *base.add(0).cast::<u8>() = (0i32) as u8;
                                    let super::super::super::super::host::parse::parsing::ParseReturn{ value:value3, cursor:cursor3, } = e;
                                    match value3 {
                                        Some(e) => {
                                            *base.add(8).cast::<u8>() = (1i32) as u8;
                                            use super::super::super::super::host::parse::parsing::ParseYield as V19;
                                            match e {
                                                V19::Message(e) => {
                                                    *base.add(16).cast::<u8>() = (0i32) as u8;
                                                ...
                                                V19::Attachment(e) => {
                                                    *base.add(16).cast::<u8>() = (1i32) as u8;
                                                    let super::super::super::super::host::parse::parsing::Attachment{ name:name5, size:size5, created_date:created_date5, modified_date:modified_date5, messages:messages5, data:data5, } = e;
                                                    let vec6 =
                                                ...
                                                V19::MessageAndAttachment(e) => {
                                                    ...
                                                    *base.add(24).cast::<*mut u8>() =
                                                        ptr12.cast_mut();
                                                    let super::super::super::super::host::parse::parsing::Attachment{ name:name13, size:size13, created_date:created_date13, modified_date:modified_date13, messages:messages13, data:data13, } = t11_1;
                                                    let vec14 =
                                ...
                                Err(e) => {
                                    *base.add(0).cast::<u8>() = (1i32) as u8;
                                    use super::super::super::super::host::parse::parsing::Error as V21;
                                    match e {
                                        V21::Parse(e) => {
                                            *base.add(8).cast::<u8>() = (0i32) as u8;
                    ...
                    *ptr2.add(4).cast::<usize>() = len22;
                    *ptr2.add(0).cast::<*mut u8>() = result22;
                    ptr2
                }
                #[doc(hidden)]
                #[allow(non_snake_case)]
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn _export_method_parser_parse_res_cabi<T: GuestParser>(
                    arg0: *mut u8,
                    arg1: *mut u8,
                    arg2: usize,
                    arg3: i32,
                    ...
                    T::parse_res(
                        ...
                        {
                            handle1 = super::super::super::super::host::parse::parsing::Results::from_handle(arg5 as u32);
                            &handle1
                        },
                    );
                }
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn _export_method_parser_parse_res_rng_cabi<T: GuestParser>(
                    arg0: *mut u8,
                    arg1: *mut u8,
                    arg2: usize,
                    arg3: i32,
                ...
                macro_rules! __export_host_parse_client_cabi{
      ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {

        #[export_name = "host:parse/client#[constructor]parser"]
        ...
        #[export_name = "host:parse/client#[method]parser.parse"]
        ...
        #[export_name = "cabi_post_host:parse/client#[method]parser.parse"]
        ...
        #[export_name = "host:parse/client#[method]parser.parse-res"]
        unsafe extern "C" fn export_method_parser_parse_res(arg0: *mut u8,arg1: *mut u8,arg2: usize,arg3: i32,arg4: i64,arg5: i32,) {
          $($path_to_types)*::_export_method_parser_parse_res_cabi::<<$ty as $($path_to_types)*::Guest>::Parser>(arg0, arg1, arg2, arg3, arg4, arg5)
        }
        #[export_name = "host:parse/client#[method]parser.parse-res-rng"]
        unsafe extern "C" fn export_method_parser_parse_res_rng(arg0: *mut u8,arg1: *mut u8,arg2: usize,arg3: i32,arg4: i64,arg5: i32,) {
          $($path_to_types)*::_export_method_parser_parse_res_rng_cabi::<<$ty as $($path_to_types)*::Guest>::Parser>(arg0, arg1, arg2, arg3, arg4, arg5)
        }

        const _: () = {
          #[doc(hidden)]
          #[export_name = "host:parse/client#[dtor]parser"]
          #[allow(non_snake_case)]
          unsafe extern "C" fn dtor(rep: *mut u8) {
            ...
            >(rep)
                ...
                #[doc(hidden)]
                pub(crate) use __export_host_parse_client_cabi;
                #[repr(align(4))]
...
macro_rules! __export_parse_impl {
  ...
  $($path_to_types_root)*::exports::host::parse::client::__export_host_parse_client_cabi!($ty with_types_in $($path_to_types_root)*::exports::host::parse::client);
  )
}
#[doc(inline)]
...
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 1018] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xfe\x06\x01A\x02\x01\
A\x0e\x01B\x15\x01ks\x01pw\x01p}\x01r\x06\x04names\x04sizew\x0ccreated-date\0\x0d\
...
\x03eof\0\0\x04\0\x05error\x03\0\x0b\x04\0\x07results\x03\x01\x01h\x0d\x01j\x01\x0a\
\x01\x0c\x01@\x02\x04self\x0e\x04item\x0f\x01\0\x04\0\x13[method]results.add\x01\
\x10\x01p\x0f\x01@\x02\x04self\x0e\x05items\x11\x01\0\x04\0\x19[method]results.a\
dd-range\x01\x12\x03\x01\x12host:parse/parsing\x05\0\x02\x03\0\0\x0aattachment\x03\
\0\x0aattachment\x03\0\x01\x02\x03\0\0\x0bparse-yield\x03\0\x0bparse-yield\x03\0\
\x03\x02\x03\0\0\x05error\x03\0\x05error\x03\0\x05\x02\x03\0\0\x0cparse-return\x03\
\0\x0cparse-return\x03\0\x07\x02\x03\0\0\x07results\x03\0\x07results\x03\0\x09\x01\
B\x19\x02\x03\x02\x01\x01\x04\0\x0aattachment\x03\0\0\x02\x03\x02\x01\x03\x04\0\x0b\
parse-yield\x03\0\x02\x02\x03\x02\x01\x05\x04\0\x05error\x03\0\x04\x02\x03\x02\x01\
\x07\x04\0\x0cparse-return\x03\0\x06\x02\x03\x02\x01\x09\x04\0\x07results\x03\0\x08\
\x04\0\x06parser\x03\x01\x01i\x0a\x01@\0\0\x0b\x04\0\x13[constructor]parser\x01\x0c\
\x01h\x0a\x01p}\x01kw\x01j\x01\x07\x01\x05\x01p\x10\x01@\x03\x04self\x0d\x04data\
\x0e\x09timestamp\x0f\0\x11\x04\0\x14[method]parser.parse\x01\x12\x01h\x09\x01@\x04\
\x04self\x0d\x04data\x0e\x09timestamp\x0f\x07results\x13\x01\0\x04\0\x18[method]\
parser.parse-res\x01\x14\x04\0\x1c[method]parser.parse-res-rng\x01\x14\x04\x01\x11\
host:parse/client\x05\x0b\x04\x01\x10host:parse/parse\x04\0\x0b\x0b\x01\0\x05par\
se\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-component\x070.202.0\x10\
