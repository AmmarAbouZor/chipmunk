...
impl SessionShared {
    ...
    fn sync_search_values_pipeline(&mut self, registry: &FilterRegistry) -> Vec<SessionCommand> {
        ...
        if filters.is_empty() {
            ...
            self.search_values.clear_operation();
...
mod tests {
    ...
    #[test]
    fn sync_filter_no_filters_drops_search() {
    ...
    #[test]
    fn sync_filter_with_filters_drop_then_apply() {
        let mut shared = new_shared();
    ...
    #[test]
    fn sync_filter_temp_search_applies() {
        let mut shared = new_shared();
        let registry = FilterRegistry::default();
        shared
            .filters
    ...
    #[test]
    fn sync_values_no_values_drops_operation() {
        let mut shared = new_shared();
        let registry = FilterRegistry::default();
        let previous_operation_id = Uuid::new_v4();
    ...
    #[test]
    fn sync_values_with_values_drop_then_apply() {
        let mut shared = new_shared();
        let mut registry = FilterRegistry::default();
    ...
    #[test]
    fn sync_both_orders_filter_then_values() {
        let mut shared = new_shared();
        let mut registry = FilterRegistry::default();
